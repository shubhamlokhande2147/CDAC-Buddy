...
public class TestInheritanceDemo {
	...
	public static void main(String[] args) {
		...
		ContractEmployee ce2 =new  ContractEmployee(6,"shiv","1344567890","emp@email.com","MaNAGER","MainHead",LocalDate.of(2007,4, 3),100000,5000);
		...
		Vendor v2 = new Vendor(10,"sagar","9455674500","emp@email.com","Hr","MainHead",LocalDate.of(2000,4,17),20,50000);
		System.out.println(v1);
	}
